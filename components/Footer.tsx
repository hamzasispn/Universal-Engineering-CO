          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <div className="mb-6 flex items-center">
                <img src="/ue-logo.svg" alt="Universal Engineering" className="h-16 w-auto" />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">Motor Control Centers</a></li>
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">PLC Control Panels</a></li>
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">Distribution Boards</a></li>
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">Switchgear Systems</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                ...
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">Case Studies</a></li>
                <li><a href="#" className="hover:text-[#355FA8] transition-colors">Careers</a></li>
              </ul>
            </div>
