          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-[#355FA8] to-[#1e3a5f] text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center sm:justify-start gap-2 text-sm sm:text-base">
